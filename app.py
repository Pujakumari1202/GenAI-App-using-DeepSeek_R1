...
def generate_ai_response(prompt_chain, user_input):
    processing_pipeline = prompt_chain | llm_engine | StrOutputParser()
    return processing_pipeline.invoke({"user_input": user_input, "chat_history": st.session_state.message_log})
...
if user_query:
    # Escape curly braces in user input to prevent KeyError
